...
mongoose
  ...
  //facebook
  /**
   * Facebook authentication configuration object.
   * @type {Object}
   * @property {string} clientID - Facebook App ID.
   * @property {string} clientSecret - Facebook App Secret.
   * @property {string} callbackURL - URL to which Facebook will redirect after authentication.
   */
  var facebookAuth = {
